  ...
  return (
    ...
    <Grid 
      ...
      <Grid container spacing={3} justifyContent="center" alignItems="center" style={{ minHeight: '30vh' }}>
        ...
        <Button fullWidth variant="contained" color="success" onClick={createConstruction}>공사 생성</Button>
        </Grid>
        <Grid item xs={8} sm={4} md={3}>
        <Button fullWidth variant="contained" color="success" onClick={getConstruction}>공사 확인</Button>
        </Grid>
        <Grid item xs={8} sm={4} md={3}>
        <Button fullWidth variant="contained" color="success" onClick={createSupervisor}>감리 생성</Button>
        </Grid>
        <Grid item xs={8} sm={4} md={3}>
        <Button fullWidth variant="contained" color="success" onClick={createConstruction}>기초공사</Button>
        </Grid>
        <Grid item xs={8} sm={4} md={3}>
